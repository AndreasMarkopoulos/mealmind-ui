    ...
    >
      <div ref="target" class="relative w-full h-full md:h-auto" :class="`${modalSizeClasses[size]}`">
        ...
        <div class="relative bg-white rounded-t-sm shadow dark:bg-gray-700">
          <!-- Modal header -->
          <div class="p-1.5 shadow-lg rounded-t-sm bg-purple-100 flex justify-between items-center" :class="$slots.header ? 'border-b border-gray-200 dark:border-gray-600' : ''">
            <slot name="header" />
