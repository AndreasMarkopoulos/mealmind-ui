<template>
  <div :id="accordionId" class="h-full">
    <h2 :id="headingId" >
      <button type="button" @click.self="toggleAccordion" class="flex items-center justify-between w-full p-1.5 font-medium bg-purple-50 text-left text-gray-500 border-gray-200">
